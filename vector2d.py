'''VECTOR2D FILE ORIGINATES FROM SWINBURNE UNIVERSITY OF TECHNOLOGY, ARTIFICIAL INTELLIGENCE FOR GAMES'''
...
class Vector2D(object):
    ...
    def __hash__(self):  #added because needed for greedy search
